...
#if 1 
#define SCL_1         GPIO_SetBits(GPIOA,GPIO_Pin_8)
#define SCL_0         GPIO_ResetBits(GPIOA,GPIO_Pin_8)
#define SDA_1         GPIO_SetBits(GPIOC,GPIO_Pin_9)
#define SDA_0         GPIO_ResetBits(GPIOC,GPIO_Pin_9)
//void IIC_OUT_SHT20(void);
//void IIC_IN_SHT20(void);
#define DIR_IN_SHT20        IIC_IN_SHT20()   
#define DIR_OUT_SHT20       IIC_OUT_SHT20()
#define SDA_IN_SHT20        GPIO_ReadInputDataBit(GPIOC,GPIO_Pin_9)    
