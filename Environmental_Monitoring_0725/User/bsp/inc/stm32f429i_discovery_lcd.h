...
#define  LCD_PIXEL_HEIGHT   ((uint16_t)854)
#endif

#define LCD_FRAME_BUFFER       ((uint32_t)/*0xD000C800*/EXT_SDRAM_ADDR)
#if 0
#define BUFFER_OFFSET          ((uint32_t)/* 0x50000 */(320 * 240 * 4))
#else
#define BUFFER_OFFSET          ((uint32_t)(854 * 480 * 2))
#endif
...
/** 
  * @brief  LCD Rest pin  
  */ 
#define LCD_NRESET_PIN             GPIO_Pin_13                 
#define LCD_NRESET_GPIO_PORT       GPIOC                      
#define LCD_NRESET_GPIO_CLK        RCC_AHB1Periph_GPIOC
/** 
  * @brief  LCD CS pin  
  */ 
#define LCD_NCSX_PIN             GPIO_Pin_8
#define LCD_NCSX_GPIO_PORT       GPIOI                      
#define LCD_NCSX_GPIO_CLK        RCC_AHB1Periph_GPIOI

#define LED_BKL_PIN             GPIO_Pin_7                 
#define LED_BKL_GPIO_PORT       GPIOF                   
#define LED_BKL_GPIO_CLK        RCC_AHB1Periph_GPIOF
...
#define PIN_MOSI	GPIO_Pin_3

#define RCC_MISO 	RCC_AHB1Periph_GPIOC
...
#define MOSI_IS_HIGH()	(GPIO_ReadInputDataBit(PORT_MISO, PIN_MISO) == Bit_SET)
#define MISO_IS_HIGH()	(GPIO_ReadInputDataBit(PORT_MOSI, PIN_MOSI) == Bit_SET)
#else
#define RCC_SCK 	RCC_AHB1Periph_GPIOG
#define PORT_SCK	GPIOG
#define PIN_SCK		GPIO_Pin_13

#define RCC_MOSI 	RCC_AHB1Periph_GPIOG
#define PORT_MOSI	GPIOG
#define PIN_MOSI	GPIO_Pin_14

#define RCC_MISO 	RCC_AHB1Periph_GPIOF
...
#define LCD_NCS_GPIO_PORT       GPIOI                      
#define LCD_NCS_GPIO_CLK        RCC_AHB1Periph_GPIOI 
...
/** 
  ...
  */ 
#define LCD_DEFAULT_FONT         /*Font16x24 */NULL
